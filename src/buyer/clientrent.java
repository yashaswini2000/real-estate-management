 ...
 */
public class clientrent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //String Result;
        //new clientrentbackframe(sqft,locn,bh).setVisible(true);
        ...
        if( locn.length()!=0 && bh.length()!=0){
            ...
            try(Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/realestate","root","yashaswini22")){
                String sql="select * from rent_owner where location=\""+locn+"\" and bhk="+bh;
    ...
    private void rentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rentActionPerformed
        ...
        try(Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/realestate","root","yashaswini22")){
                ...
                System.out.println("Insert into client values(\""+LoginF.em+"\","+mod.getValueAt(row,1).toString()+","+mod.getValueAt(row,2).toString()+","+mod.getValueAt(row,3).toString()+",\""+mod.getValueAt(row,4).toString()+"\",\""+mod.getValueAt(row,5).toString()+"\")");
                String sql2 = "Insert into client values(\""+LoginF.em+"\","+mod.getValueAt(row,1).toString()+","+mod.getValueAt(row,2).toString()+","+mod.getValueAt(row,4).toString()+",\""+mod.getValueAt(row,3).toString()+"\",\""+mod.getValueAt(row,7).toString()+"\")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clientrent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clientrent().setVisible(true);
            }
        });
    }
